class APIfeatures {
    ...
    getFilterCriteria() {
        ...
        // Example: Extracting a 'name' filter from the query string
        if (this.queryString.name) {
          filterCriteria.name = this.queryString.name;
        }
    
        // Add more conditions based on your application's requirements
